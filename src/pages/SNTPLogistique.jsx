...
const SNTPLogistique = () => {
  ...
  window.open('https://www.google.com/maps/place/SNTP+Atelier+mécanique+khemis+el+khechna/data=!4m2!3m1!1s0x0:0xc94c3d90e1bcee4c?sa=X&ved=1t:2428&ictx=111', '_blank', 'noopener,noreferrer');
};
