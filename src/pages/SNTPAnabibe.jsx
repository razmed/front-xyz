...
const SNTPAnabibe = () => {
  ...
  return (
    <div className="Anabibe-page">
      ...
      <section className="Anabibe-expertise-section Anabibe-fade-in-section">
        <div className="Anabibe-section-header">
          <h2 className="Anabibe-section-title">EXPERTISE TECHNIQUE AVANCÉE</h2>
        </div>
      </section>
