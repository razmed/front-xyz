...
const BatimentsIndustriels = () => {
  ...
  return (
    <div className="BatimentsIndustriels-page">
      {/* Hero Section */}
      <section className="BatimentsIndustriels-hero" style={{backgroundImage: 'url(/images/industrial-hero.jpg)'}}>
        ...
        <div className="BatimentsIndustriels-hero-content BatimentsIndustriels-container">
          <div className="BatimentsIndustriels-hero-kicker">
          ...
          <div className="BatimentsIndustriels-hero-actions">
            <button className="BatimentsIndustriels-btn BatimentsIndustriels-btn-primary">
              Demander un Devis
            </button>
            <button className="BatimentsIndustriels-btn BatimentsIndustriels-btn-outline-light">
              Nos Réalisations
            </button>
          </div>
        </div>
